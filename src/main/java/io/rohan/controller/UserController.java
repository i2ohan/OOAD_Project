...
import io.rohan.model.User;
import io.rohan.repo.UserRepository;
...
public class UserController 
{
	...
	//for handling house number entered by user and displaying the details.jsp
	@PostMapping("/display")
	...
	if(auser!=null)
	{
		...
		else if(username.equalsIgnoreCase(uname) && password.equalsIgnoreCase(upass)) 
		{
			session.setAttribute("username",username);
			return "user";
		}
